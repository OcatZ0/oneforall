...
<div class="grid-stack" id="integrity-monitoring-grid">
  ...
  {{-- METRICS --}}
  <div class="grid-stack-item" gs-id="fim-metrics" gs-x="0" gs-y="0" gs-w="9" gs-h="3">
  ...
  {{-- TIME RANGE --}}
  <div class="grid-stack-item" gs-id="fim-timerange" gs-x="9" gs-y="0" gs-w="3" gs-h="3">
    <div class="grid-stack-item-content">
      <div class="card gs-card">
  ...
  {{-- FIM EVOLUTION --}}
  <div class="grid-stack-item" gs-id="fim-evolution" gs-x="0" gs-y="3" gs-w="6" gs-h="9">
    <div class="grid-stack-item-content">
      <div class="card gs-card">
        <div class="card-header py-2">
  ...
  <div class="grid-stack-item" gs-id="fim-top-rules" gs-x="6" gs-y="3" gs-w="6" gs-h="9">
    <div class="grid-stack-item-content">
      <div class="card gs-card">
        <div class="card-header py-2">
  ...
  <div class="grid-stack-item" gs-id="fim-top-modified" gs-x="0" gs-y="12" gs-w="4" gs-h="8">
    <div class="grid-stack-item-content">
      <div class="card gs-card">
        <div class="card-header py-2">
  ...
  {{-- TOP 5 DELETED FILES --}}
  <div class="grid-stack-item" gs-id="fim-top-deleted" gs-x="4" gs-y="12" gs-w="4" gs-h="8">
    <div class="grid-stack-item-content">
      <div class="card gs-card">
        <div class="card-header py-2">
  ...
  {{-- TOP 5 ADDED FILES --}}
  <div class="grid-stack-item" gs-id="fim-top-added" gs-x="8" gs-y="12" gs-w="4" gs-h="8">
    <div class="grid-stack-item-content">
      <div class="card gs-card">
        <div class="card-header py-2">
  ...
  {{-- FIM EVENTS TABLE --}}
  <div class="grid-stack-item" gs-id="fim-events-table" gs-x="0" gs-y="20" gs-w="12" gs-h="10">
    <div class="grid-stack-item-content">
      <div class="card gs-card">
        <div class="card-header py-2">
